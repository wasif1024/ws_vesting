...
export type CloseInput<
  ...
  TAccountWsVesting extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountWsVesting>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountWsVesting> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.ws-vesting),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountWsVesting>;
