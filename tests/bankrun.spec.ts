...
import IDL from "../target/idl/ws_vesting1.json";
import {WsVesting1 } from "../target/types/ws_vesting1";
...
describe("Vesting Smart Contract Tests", () => {
  ...
  let program: Program<WsVesting1>;
  let banksClient: BanksClient;
  let employer: Keypair;
  let mint: PublicKey;
  let beneficiaryProvider: BankrunProvider;
  let program2: Program<WsVesting1>;
  ...
  before(async () => {
    ...
    context = await startAnchor(
      "",
      [{ name: "ws_vesting1", programId: new PublicKey(IDL.address) }],
      [
        {
    ...
    program = new Program<WsVesting1>(IDL as WsVesting1, provider);
    ...
    program2 = new Program<WsVesting1>(IDL as WsVesting1, beneficiaryProvider);
